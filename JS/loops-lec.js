...
// (0, 1, 2...9)
// i is where the loop starts
// var i = 0;
// while(i < 10){
//     console.log(i);
//     // i++ increaments i to break the loop
//     i++;
// }
...
// var userConfirm;
// // without assigning the confirm we cant catch the value
//
// while(!userConfirm){
...
// will continue to run until the "blue" is typed and then stops
//
// do {
